...
RUN apt-get install -y python3-dev python3-pip postgresql-client-common postgresql-contrib-9.6 postgresql-9.6 libpq-dev git curl libmemcached-dev curl openssh-server mercurial gettext vim libjpeg-dev libjpeg8-dev
